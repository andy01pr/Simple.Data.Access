...
namespace Simple.Data.Access
{
    ...
    ///
    /// </summary>
    /// <seealso cref="Simple.Data.Ado.Schema.ISchemaProvider" />
    public class AccessSchemaProvider : ISchemaProvider
    {
        ...
        {
            return GetOleDbSchema(OleDbSchemaGuid.Tables).AsEnumerable().Select(SchemaRowToTable);
        }
        ...
        {
            if (unquotedName == null) throw new ArgumentNullException(nameof(unquotedName));
        ...
        #endregion ISchemaProvider Members
        ...
        public static Type DataTypeToClrType(string dataType)
        {
        ...
        #endregion Nested type: DBCOLUMNFLAGS
    }
}